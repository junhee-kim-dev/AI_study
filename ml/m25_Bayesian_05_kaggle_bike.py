...
#        best_score : 0.9994708895683289
#  model_best_score : 0.9994398355484009
#    accuracy_score : 0.9994398355484009
#      running_time : 5.028 sec

#       best_params : {'learning_rate': 0.1, 'max_depth': 6, 'n_estimators': 500}
#        best_score : 0.9994751811027527
#  model_best_score : 0.9994668364524841
#    accuracy_score : 0.9994668364524841
#      running_time : 7.846 sec

# 추천 조합 : {'target': 0.9996352195739746, 'params': {'colsample_bylevel': 1.0, 'colsample_bytree': 1.0, 
# 'gamma': 0.0, 'learning_rate': 0.1, 'max_bin': 500.0, 'max_depth': 10.0, 'min_child_weight': 1.0, 
# 'n_estimators': 351.810269842155, 'reg_alpha': 10.0, 'reg_lambda': 0.0, 'subsample': 0.5}}
