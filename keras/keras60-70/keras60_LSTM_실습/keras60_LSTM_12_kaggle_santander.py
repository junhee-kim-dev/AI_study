...
# exit()
x_train = x_train.reshape(-1,10,20)
x_test = x_test.reshape(-1,10,20)
from keras.layers import LSTM, Dropout, Flatten, Conv2D, MaxPooling2D
from keras.callbacks import EarlyStopping, ModelCheckpoint
import datetime
import time
...
# model.add(Dropout(0.2))
model.add(LSTM(128, input_shape=(10,20)))
