...
x = np.load(npy_path + '2_clean_feat_(144steps_36st)x.npy')
y = np.load(npy_path + '2_clean_feat_(144steps_36st)y.npy')
test = np.load(npy_path + '2_clean_feat_(144steps_36st)test.npy')
