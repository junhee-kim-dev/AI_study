...
#1. 결측치 삭제
print(data.dropna())    # 디폴트는 행이다. axis=0
#      0    1    2    3
# 3  8.0  8.0  8.0  8.0
...
#2-4 특정값 - ffill (통상 마지막 값, 마지막 시계열)
data5 = data.ffill()
print(data5)    # 가장 첫번째 행은 참고할 값이 없어서 Nan
#       0    1     2    3
# 0   2.0  2.0   2.0  NaN
# 1   2.0  4.0   4.0  4.0
# 2   6.0  4.0   6.0  4.0
...
#2-5 특정값 - bfill (통상 첫번째값, 첫번째 시계열 값)
data6 = data.bfill()
print(data6)    # # 가장 마지막 행은 참고할 값이 없어서 Nan
#       0    1     2    3
# 0   2.0  2.0   2.0  4.0
# 1   6.0  4.0   4.0  4.0
# 2   6.0  8.0   6.0  8.0
