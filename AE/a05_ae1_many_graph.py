...
outputs = [
    x_test, decoded_imgs_01, decoded_imgs_02, decoded_imgs_03, decoded_imgs_04,
    decoded_imgs_05, decoded_imgs_06, decoded_imgs_07, decoded_imgs_08
]

for row_num, row in enumerate(axes) :
    for col_num, ax in enumerate(row):
        ax.imshow(outputs[row_num][random_images[col_num]].shape(28,28), cmap='gray')
        ax.grid(False)
        ax.set_xticks([])
        ax.set_yticks([])
